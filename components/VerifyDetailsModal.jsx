 ...
 * - isOpen: boolean
 * - onClose: function
 * - onEdit: function (callback to go back to the previous step without losing data)
 * - bookingData: object containing:
 *   - name / fullName
 *   - mobile / phone
 *   - email
 *   - service
 *   - selectedDate (optional / default 'Flexible / As soon as possible')
 *   - selectedSlot (optional / default 'Flexible (10:00 AM - 07:00 PM)')
 *   - projectBrief / requirements / notes
 */
